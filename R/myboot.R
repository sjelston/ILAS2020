...
#'
#' This function creates a bar plot from a sample of values using a specified
#' function to calculate statistics and builds confidence intervals of a specified size
#'
#' @param iter Number of iterations to be performed
#' @param x The vector containing values to do operations on
#' @param fun Name of the function to use when calculating confidence intervals
#' @param alpha Dictates that we are creating confidence intervals of size 100(1-alpha)%
#'
#' @return A list object featuring useful information from the calculations
#' @export
#'
#' @examples
#' myboot(iter=1000,x=sample,fun="var",alpha=0.2)
